        ...
        <>
            ...
            <div className="relative w-[160px] h-1">
                ...
                <input
                    ...
                    max="1"
                    step="0.01"
                    className="volume-slider range absolute inset-0 w-full h-full appearance-none bg-transparent dark:bg-gray-700 focus:outline-none rounded-md cursor-pointer"
                    value={volume}
